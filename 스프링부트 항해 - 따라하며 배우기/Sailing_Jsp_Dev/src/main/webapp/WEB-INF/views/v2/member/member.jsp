<%@ page import="com.example.sailing_jsp_dev.v2.vo.Cust_info" %>
...
<div id="main" style="font-size:large; text-align: center; ">
    ...
    <table class="table">
        ...
        <tr>
            <td><input type="checkbox" name="chkMemberNo" value="<%=cust_info.getNo()%>"></td>
            <th><%=cust_info.getCust_id()%></th>
            <td><%=cust_info.getName()%></td>
            <td><%=cust_info.getEmail()%></td>
            <td><%=cust_info.getRole()%></td>
            <td><%=cust_info.getReg_day()%></td>
        </tr>
        <% } %>
        </tbody>
    </table>
