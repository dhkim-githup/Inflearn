package com.example.sailing_jsp_dev.v2.controller;

import com.example.sailing_jsp_dev.v2.service.MemberSvcV2;
import com.example.sailing_jsp_dev.v2.vo.Cust_info;
...
public class MemberConV2 {
    ...
    public String doMember(Model model){
        ...
        model.addAttribute("hello", " ========== MemberConV2_member ======== ");
    ...
    public String doSearch( @RequestParam("start_date") String strStartDate,
        ...
        model.addAttribute("list", list);
        model.addAttribute("hello", " ========== MemberConV2_member_search ======== ");
